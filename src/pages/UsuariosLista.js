                        ...
                        this.state.usuario_data.map((item) => {
                          return (
                            <div>
                              ...
                              <IonItem>
                                <IonInput type="text" id="usuario" value={item.usuario} key={item.id} readonly></IonInput>
                                <IonButton onClick={() => this.editarInfoUsuario('usuario')}>Editar</IonButton>
                              </IonItem>
                              
                              <IonInput type="hidden" id="clave_hidden" value={item.clave} key={item.id}></IonInput>
                              <IonItem style={{ fontSize: "14px" }}>
                                <IonLabel>Clave:</IonLabel>
                              </IonItem>
                              <IonItem>
                                <IonInput type="password" id="clave" key={item.id} readonly></IonInput>
                              ...
                              <IonItem>
                                <IonInput type="text" id="tipo" value={item.tipo} key={item.id} ></IonInput>
                              </IonItem>
                              ...
                              <IonItem>
                                <IonInput type="text" id="fecha_ingresa" value={item.fecha_ingresa} key={item.id} readonly></IonInput>
                              </IonItem>
                              ...
                              <IonItem>
                                <IonInput type="text" id="usuario_ingresa" value={item.usuario_ingresa} key={item.id} readonly></IonInput>
                              </IonItem>

                              <IonItem>
                                <IonLabel>¿Activo?</IonLabel>
                                <IonSelect okText="Aceptar" id="activo" value={item.activo} cancelText="Cancelar" placeholder={item.activo == 1 ? 'Activo' : 'Inactivo'} interface="action-sheet" key={item.id}>
